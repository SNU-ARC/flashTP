...
base_path="./ir_config"
result_path="./ablation0120_v2"

nequip_path="$base_path/nequip"
hs=(32) #  64
lmaxs=(4 3 2 1) # 1 2 3 4 5 6
layer_idxs=(3) # 0 1 2 
OPS_TYPE=("ppd" "pid" "pps" "pis") 

target_batch_sizes=(32768) # 16384 
DTYPES=("fp32") # "fp64" "fp32" 
model="nequip"
            ...
            for layer_idx in "${layer_idxs[@]}"; do
                for target_batch_size in "${target_batch_sizes[@]}"; do
                    for op_type in "${OPS_TYPE[@]}"; do
                        ...
                        folder_path="${result_path}/${dtypes}/${model}_h_${h}_lmax_${lmax}_bsize_${target_batch_size}_layer_${layer_idx}_exp_${op_type}"
                        ...
                        echo "Running with: $filename, $layer_idx, $target_batch_size, 4, $run_cueq, $run_e3nn, $op_type" 

                        CUDA_VISIBLE_DEVICES=1 python ${py_name} ${filename} ${layer_idx} ${target_batch_size} 4 ${dtypes} ${run_cueq} ${result_path} ${run_e3nn} ${op_type}
