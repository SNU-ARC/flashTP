...
base_path="./ir_config"
result_path="./result0502_prev"

nequip_path="$base_path/nequip"
hs=(32) #  64
lmaxs=(1 2 3 4) # 1 2 3 4 5 6
layer_idxs=(3) # 0 1 2 
        ...
        for lmax in "${lmaxs[@]}"; do
            ...
            for layer_idx in "${layer_idxs[@]}"; do
                for target_batch_size in "${target_batch_sizes[@]}"; do
                    ...
                    CUDA_VISIBLE_DEVICES=0 python ${py_name} ${filename} ${layer_idx} ${target_batch_size} 4 ${dtypes} ${run_cueq} ${result_path} ${run_e3nn} 1
