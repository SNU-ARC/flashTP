...
def main():
    ...
    for i in range(1):
        ...
        # ) as p:
            ...
            print(out_ours[0])
            flashTP_e3nn.utils.compare(out_ours[0], out_exp[0])
            ...
            print(f_in2_c[0])
            print(f_weight_c[3])
            flashTP_e3nn.utils.compare(f_in1[0], f_in1_c[0])
            flashTP_e3nn.utils.compare(f_in2[0], f_in2_c[0])
            flashTP_e3nn.utils.compare(f_weight[0], f_weight_c[0])
            ...
            print(in2_c.grad[0])
            print(weight_c.grad[0])

            flashTP_e3nn.utils.compare(in1_node.grad[0], in1_node_c.grad[0])
            flashTP_e3nn.utils.compare(in2.grad[0], in2_c.grad[0])
            flashTP_e3nn.utils.compare(weight.grad[0], weight_c.grad[0])
